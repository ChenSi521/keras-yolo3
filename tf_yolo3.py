...
def parse_args():
    ...
    parser.add_argument("-model_path", "-m", required=True, help="path to the freezed tensorflow yolov3 model")
    parser.add_argument("--anchor_path", "-a", required=True, help="path to the file contains yolov3 anchors")
    parser.add_argument("--label_path", "-l", required=True, help="path to the text file contains all class names")
...
class TFYOLO(object):
    def __init__(self, model_path, anchor_path, label_path, score_thresh=0.5, nms_iou_thresh=0.45):
        ...
        self._boxes, self._scores, self._classes = yolo_eval(self._output_tensor_list, self._anchors,
                                                             len(self._class_names), self._input_image_shape,
